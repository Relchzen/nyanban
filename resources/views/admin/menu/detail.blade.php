            ...
            <div class="mb-4 grid grid-cols-8">              
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 col-span-full">
                    <div class="md:col-span-4">
                        ...
                        <div class="mt-2">
                        <input type="file" name="picture" id="picture" class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="{{ $menu->picture }}">{{ $menu->picture}}
                        </div>
                    </div>
                    <div class="md:col-span-4">
                        <label for="menu_name" class="block text-sm font-medium leading-6 text-gray-900">Menu Name</label>
